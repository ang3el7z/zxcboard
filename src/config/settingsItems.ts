...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    label: 'zxcboardSettings',
    items: [
      { key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.actions`, label: 'actions' },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.autoSwitchTheme`,
        label: 'autoSwitchTheme',
      },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.defaultTheme`,
        label: 'defaultTheme',
      },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.darkTheme`,
        label: 'darkTheme',
      },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.customBackgroundURL`,
        label: 'customBackgroundURL',
      },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.transparent`,
        label: 'transparent',
      },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.blurIntensity`,
        label: 'blurIntensity',
      },
      { key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.fonts`, label: 'fonts' },
      { key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.emoji`, label: 'emoji' },
      { key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.language`, label: 'language' },
      {
        key: `${SETTINGS_MENU_KEY.general}.zxcboardSettings.autoUpgradeDashboard`,
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: `${SETTINGS_MENU_KEY.overview}.latencyServices`,
        label: 'latencyServices',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: `${SETTINGS_MENU_KEY.proxies}.manageHiddenGroup`,
