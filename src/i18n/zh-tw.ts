...
const zhTW: LANG_MESSAGE = {
  ...
  unavailable: '不可用',
  protocolTips:
    '您正在嘗試連接一個 HTTP 後端，但 zxcboard 是透過 HTTPS 提供的，這可能會導致連接錯誤。請在瀏覽器設定中允許不安全內容，或者透過 HTTP 開啟 zxcboard。',
  global: '全域',
  direct: '直連',
  ...
  autoDisconnectIdleUDPTip:
    '啟用後，開啟 zxcboard 時將關閉持續時間超過配置分鐘數的 UDP 連接，這可能對某些無法正常自動斷開的 UDP 連接帶來幫助。(這是作者自己的私貨，你大概率不需要開啟它)',
  ...
  importFromBackendTip:
    '預設的 ./zxcboard-settings.json 位於 ui 資料夾下，匯入前請確保 ui 資料夾下存在配置檔案。',
  importFailed: '匯入失敗，請檢查url {url}',
  autoImportFromUrl: '自動匯入',
  autoImportFromUrlTip:
    '啟用後，每次開啟 zxcboard 時會自動從 URL 設定匯入並計算 hash，如果 hash 與上次匯入的 hash 不同，則重新匯入並重新整理頁面。',
  getting: '獲取中...',
