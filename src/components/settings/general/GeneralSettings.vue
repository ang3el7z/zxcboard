<template>
  <template v-if="hasVisibleGeneralItems">
    ...
    <div class="settings-grid">
      <div
        v-if="displayAllFeatures && isVisibleActions"
        class="setting-item"
      >
      ...
      <div
        v-if="isVisibleDisplayAllFeatures"
        class="setting-item"
      >
        <div class="setting-item-label">
...
const hasVisibleGeneralItems = computed(() => {
  return (
    (displayAllFeatures.value && isVisibleActions.value) ||
    ...
    isVisibleDisplayAllFeatures.value
  )
})
</script>
