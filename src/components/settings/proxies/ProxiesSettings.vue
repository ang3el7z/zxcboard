<template>
  <div class="flex flex-col text-sm">
    <template v-if="displayAllFeatures && hasVisibleLatencyItems">
    ...
    <template v-if="hasVisibleProxyStyleItems">
      ...
      <div class="settings-grid">
        ...
        <div
          v-if="displayAllFeatures && isVisibleDisplayGlobalByMode"
          class="setting-item"
        >
          <div class="setting-item-label">
        ...
        <div
          v-if="displayAllFeatures && isVisibleManageHiddenGroup"
          class="setting-item"
        >
          <div class="setting-item-label">
            {{ $t('manageHiddenGroup') }}
          ...
          <input
            class="toggle"
            type="checkbox"
            v-model="manageHiddenGroup"
          />
        </div>
        <div
          v-if="displayAllFeatures && displayGlobalByMode && isSingBox && isVisibleCustomGlobalNode"
          class="setting-item"
        >
          <div class="setting-item-label">
            {{ $t('customGlobalNode') }}
...
const isVisibleManageHiddenGroup = useIsSettingVisible(k.manageHiddenGroup)
...
const hasVisibleProxyStyleItems = computed(() => {
  return (
    ...
    (displayAllFeatures.value && isVisibleDisplayGlobalByMode.value) ||
    (displayAllFeatures.value && isVisibleManageHiddenGroup.value) ||
    (displayAllFeatures.value &&
      displayGlobalByMode.value &&
      isSingBox.value &&
      isVisibleCustomGlobalNode.value) ||
