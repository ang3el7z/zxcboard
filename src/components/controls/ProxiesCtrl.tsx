...
import { hasVisibleProxyGroups, renderProxiesPageItems } from '@/composables/proxies'
...
export default defineComponent({
  ...
  setup() {
    ...
    const showProviderTab = computed(() => {
      return displayAllFeatures.value && hasProviders.value && hasVisibleProxyGroups.value
    })

    const hasVisibleItems = computed(() => {
      if (proxiesTabShow.value === PROXY_TAB_TYPE.PROVIDER) {
        return showProviderTab.value
      }

      return hasVisibleProxyGroups.value
    })
    ...
    return () => {
      ...
      const upgradeAllIcon = showProviderTab.value && proxiesTabShow.value === PROXY_TAB_TYPE.PROVIDER && (
        <button
      ...
      const latencyTestAll = hasVisibleProxyGroups.value && (
        <button
          class="btn btn-circle btn-sm"
      ...
      const toggleCollapseAll = hasVisibleItems.value && (
        <button
          class={[
          ...
          >
            <div class="flex flex-col gap-3 text-sm">
              <div class="settings-grid">
                ...
                {displayAllFeatures.value && hasSmartGroup.value && (
                  <div class="setting-item">
